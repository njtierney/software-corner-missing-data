...
We can use `visdat`'s `vis_miss()` function from visdat to visualises the missingness of a whole dataframe at once. It displays the data as missing, or not missing, and provides the amount of missings in each columns:
